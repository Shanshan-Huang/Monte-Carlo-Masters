...
parser.add_argument('--reward_mode', type=int, default=0, help='0:sparse reward; 1:discontinuous reward; 2:linear_peak; 3:squared function; 4:gaussian function; please see section 3.3 in the report for more details' )
...
plt.savefig("test20.png", dpi=500)
